		...
		<div style="width: 495px; height: 450px; float: right; margin-top: 30px; border: 1px solid;">
			...
			<div style="width: 495px; height: 80px; float: right; margin-top: 70px;" align="center";>
				<span class="STYLE1">用户名:</span>
				 ...
				 title="只能包含数字并且为11位的电话号码" type="text" required="required" maxlength="11" 
			...
			<div style="width: 495px; height: 80px; float: right;" align="center";>
				...
				<input pattern="^[a-zA-Z0-9_]{6,20}$" title="6-20位字符，可使用字母、数字和_的组合" type="password" required="required" style="height: 30px;width:270px;" name="userPsw" />
			</div>
			<div style="width: 495px; height: 80px; float: right;" align="center";>
